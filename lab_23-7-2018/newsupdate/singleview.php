        ...
        <?php
            ...
            if (mysqli_num_rows($result) > 0)
            {
                while($row = mysqli_fetch_assoc($result))
                {
					if($row['edited']==1)
					{
						echo "<div class='panel-group'><div class='panel panel-primary'><div class='jumbotron'><h2>".$row['heading']."</h2> -By Admin at " .$row['datetime']."<h6 style='color:red'>(edited)</h6></div><div class='panel-body'>".$row['summertext'] ."</div></div></div>";
						continue;
					}
